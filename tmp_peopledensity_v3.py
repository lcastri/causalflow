...
CIEDIR = '/home/lcastri/git/darko-peopleflow/HRISim_docker/HRISim/prediction/hrisim_prediction_manager/CIEs/CIE_DARKO_v3/cie.pkl'
...
prior_knowledge = {'WP': DATA_DICT_TEST.d['WP'].values[:]}
res = cie.whatIf(NODES.TOD.value, 
                 DATA_DICT_TEST.d.values[:, DATA_DICT_TEST.features.index(NODES.TOD.value)], 
