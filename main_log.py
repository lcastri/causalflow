...
if __name__ == '__main__':   
    ...
    dynotears = DYNOTEARS(df,
                          ...
                          alpha = pcmci_alpha,
                          neglect_only_autodep = True,)
                        #   resfolder='results/log/dynotears')
    cm = dynotears.run()
    ...
    varlingam = VarLiNGAM(df,
                          ...
                          alpha = pcmci_alpha,
                          neglect_only_autodep = True,)
                        #   resfolder='results/log/varlingam')
    cm = varlingam.run()
