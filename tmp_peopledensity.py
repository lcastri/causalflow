...
DATA_DICT_TRAIN = Data(starting[CM.features + ["pf_elapsed_time"]].values[:len(starting) - starting_len], varnames = CM.features + ["pf_elapsed_time"])
DATA_DICT_TEST = Data(concat_df[CM.features + ["pf_elapsed_time"]].values[len(starting) - starting_len:], varnames = CM.features + ["pf_elapsed_time"])
DATA_PD_TRAIN = Data(concat_PD[:len(starting) - starting_len], varnames = ["PD"])
DATA_PD_TEST = Data(concat_PD[len(starting) - starting_len:], varnames = ["PD"])
