...
DAGDIR = '/home/lcastri/git/darko-peopleflow/HRISim_docker/HRISim/prediction/hrisim_prediction_manager/DAGs/DARKO_v2/res.pkl'
...
for bagname in BAGNAME:
    for wp in [WP.WA_1_R, WP.WA_2_R, WP.WA_3_R, WP.WA_3_CR, WP.WA_4_R, WP.WA_5_R,
               WP.WA_1_C, WP.WA_2_C, WP.WA_3_C, WP.WA_4_C, WP.WA_5_C,
               WP.WA_1_L, WP.WA_2_L, WP.WA_3_L, WP.WA_3_CL, WP.WA_4_L, WP.WA_5_L,
               WP.TARGET_1, WP.TARGET_2, WP.TARGET_3, WP.TARGET_4, WP.TARGET_5, WP.TARGET_6, WP.TARGET_7]:
        for tod in TOD:
        ...
        DATA_DICT[idx].shrink(["TOD", "PD", "WP"])
        del concatenated_df
