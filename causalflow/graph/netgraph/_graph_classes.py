...
class BaseGraph(object):
    ...
    def __init__(self, edges,
        ...
        self.draw_edges(self.edges, self.edge_layout.edge_paths, edge_width,
            edge_color, edge_alpha, edge_zorder, arrows, self.node_artists, tail_color)
    ...
    def draw_edges(self, edges, edge_path, edge_width, edge_color, edge_alpha,
                   edge_zorder, arrows, node_artists, tail_color):
        ...
        for edge in edge_path:
            ...
            try:
                ...
                if arrows[edge]['h'] != '' and arrows[edge]['h'] != '>':
                    edge_artist.draw_head_marker(self.ax, arrows[edge]['t'], tail_color, edge_color[edge], node_artists[source].size)
                if arrows[edge]['t'] != '':
                    edge_artist.draw_tail_marker(self.ax, arrows[edge]['t'], tail_color, edge_color[edge], node_artists[source].size)
