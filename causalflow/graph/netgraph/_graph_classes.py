        ...
        for edge in edge_path:
            ...
            try:
                ...
                if arrows[edge]['h'] != '' and arrows[edge]['h'] != '>':
                    edge_artist.draw_head_marker(self.ax, arrows[edge]['t'], tail_color, tail_color, node_artists[source].size)
                if arrows[edge]['t'] != '':
                    edge_artist.draw_tail_marker(self.ax, arrows[edge]['t'], tail_color, tail_color, node_artists[source].size)
