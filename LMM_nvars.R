...
fpr <- read.csv("~/git/connectingdots/results/rebuttal/nvariable_nonlin_1250_250/fpr_bootstrapped.csv")
N_SpuriousLinks <- read.csv("~/git/connectingdots/results/rebuttal/nvariable_nonlin_1250_250/N_SpuriousLinks_bootstrapped.csv")
N_EquiDAG <- read.csv("~/git/connectingdots/results/rebuttal/nvariable_nonlin_1250_250/N_EquiDAG_bootstrapped.csv")
shd <- read.csv("~/git/connectingdots/results/rebuttal/nvariable_nonlin_1250_250/shd_bootstrapped.csv")
f1_score <- read.csv("~/git/connectingdots/results/rebuttal/nvariable_nonlin_1250_250/f1_score_bootstrapped.csv")
time <- read.csv("~/git/connectingdots/results/rebuttal/nvariable_nonlin_1250_250/time_bootstrapped.csv")
