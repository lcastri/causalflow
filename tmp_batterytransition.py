...
DATA_DICT_TRAIN = Data(morning[CM.features + ["pf_elapsed_time"]].values[:len(morning) - morning_len], varnames = CM.features + ["pf_elapsed_time"])
DATA_DICT_TEST = Data(concat_df[CM.features + ["pf_elapsed_time"]].values[len(morning) - morning_len:len(morning) + lunch_len], varnames = CM.features + ["pf_elapsed_time"])
